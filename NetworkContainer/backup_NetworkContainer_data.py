...
with open('backup_NetworkContainer_data.csv', 'w', newline='') as csv_file:
    fieldnames = ['Network Container', 'Comment', 'Alignment', 'Allocation Method', 'Banner', 'Building', 'Block', 'Country', 'Delivery Channel', 'Description', 'Environment', 'Location-Suburb', 'Operational State', 'Partner', 'Product Owner', 'Region', 'Request Number', 'Service Owner', 'Site', 'Site ID', 'Site Type', 'Source Firewall', 'State', 'Technical Function', 'VLAN', 'VLAN Name', 'Zone']
